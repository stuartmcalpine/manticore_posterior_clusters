...
def main():
    ...
    parser.add_argument('mode', choices=['1', '2', '3'], help='Mode to run (1, 2, or 3)')
    parser.add_argument('--config', default='config.toml', help='Path to config file (default: config.toml)')
    parser.add_argument('--output', default='output', help='Output directory (default: output)')
    parser.add_argument('--mpi-np', type=int, default=1, help='Number of MPI processes for mode 2 (default: 1)')
